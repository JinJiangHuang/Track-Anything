...
from scripts.track_anything import TrackingAnything
from scripts.track_anything import parse_augment
import requests
import json
import torchvision
import torch 
...
def on_ui_tabs():
    ...
    return [(track_iface, "track_anything", "track_anything")]
